...
export class ApiKeyServiceProxy {
    ...
    makeApiKey(): Observable<CreateApiKeyDto> {
        let url_ = this.baseUrl + "/api/services/app/ApiKey/MakeApiKey";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    get(id: number | undefined): Observable<ApiKeyDto> {
        let url_ = this.baseUrl + "/api/services/app/ApiKey/Get?";
        if (id === null)
    ...
    protected processGet(response: HttpResponseBase): Observable<ApiKeyDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getAll(sorting: string | null | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<ApiKeyDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/ApiKey/GetAll?";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ApiKeyDtoPagedResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<ApiKeyDtoPagedResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<ApiKeyDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ApiKeyDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
    ...
    create(body: CreateApiKeyDto | undefined): Observable<ApiKeyDto> {
        let url_ = this.baseUrl + "/api/services/app/ApiKey/Create";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    update(body: CreateApiKeyDto | undefined): Observable<ApiKeyDto> {
        let url_ = this.baseUrl + "/api/services/app/ApiKey/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdate(response: HttpResponseBase): Observable<ApiKeyDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    delete(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/ApiKey/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
...
export class ProductServiceProxy {
     ...
     * @return Success
     */
    update(productId: number | undefined, body: UpdateProductDto | undefined): Observable<UpdateProductDto> {
     ...
     * @return Success
     */
    getAllProductPaging(body: GetProductPagingRequest | undefined): Observable<ProductDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Product/GetAllProductPaging";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAllProductPaging(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllProductPaging(<any>response_);
                } catch (e) {
    ...
    protected processGetAllProductPaging(response: HttpResponseBase): Observable<ProductDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class StorageServiceServiceProxy {
     ...
     * @return Success
     */
    deleteFile(fileName: string | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/StorageService/DeleteFile?";
     ...
     * @return Success
     */
    getFileUrl(fileName: string | null | undefined): Observable<string> {
     ...
     * @return Success
     */
    saveFile(fileName: string | null | undefined, body: Stream | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/StorageService/SaveFile?";
        if (fileName !== undefined)
            url_ += "fileName=" + encodeURIComponent("" + fileName) + "&";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processSaveFile(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class ApiKeyDtoPagedResultDto implements IApiKeyDtoPagedResultDto {
    totalCount: number;
    items: ApiKeyDto[] | undefined;

    constructor(data?: IApiKeyDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["items"])) {
                ...
                for (let item of _data["items"])
                    this.items.push(ApiKeyDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): ApiKeyDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new ApiKeyDtoPagedResultDto();
        result.init(data);
        return result;
    }
...
export class GetProductPagingRequest implements IGetProductPagingRequest {
    keyword: string | undefined;
    skipCount: number;
    maxResultCount: number;

    constructor(data?: IGetProductPagingRequest) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): GetProductPagingRequest {
        data = typeof data === 'object' ? data : {};
        let result = new GetProductPagingRequest();
        result.init(data);
        return result;
    }
...
export interface IGetProductPagingRequest {
    keyword: string | undefined;
    skipCount: number;
    maxResultCount: number;
}
